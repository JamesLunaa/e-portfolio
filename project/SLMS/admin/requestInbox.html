            ...
            <div class="card min-vh-100 cardBorder" style="width: 200%;">
                ...
                <div class="card-body mainDisplay">
                    ...
                    <div class="text-center mt-2 mx-4">
                        <form class="mb-3 d-flex gap-2" action="requestInbox.php" method="post">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="requestInbox.php"><button type="submit"
                        ...
                        <div class="vh-auto recHeight">
                            ...
                            <table class="table table-dark">
                                ...
                                <tbody class="text-center">
                                    <?php
                                    include('../../model/admin/requestInbox.php');
                                    ?>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="">
                        <a href="approvedList.php"><button name="search" class="mb-2 btn btn-warning text-white"
                                type="submit">Approved
                                List</button></a>
                    </div>
                </div>
            </div>
