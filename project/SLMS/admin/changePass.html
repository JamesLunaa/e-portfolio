    ...
    <div class="mainCont d-flex text-white">
        ...
        <div class="card cardBorder d-flex flex-column flex-shrink-0"
            ...
            <div class="card-body border-end border-secondary">
                ...
                <ul class="fs-5 nav nav-pills flex-column mb-auto vh-100">
                    <li class="nav-item">
        ...
        <div class="d-flex min-vh-100" style="width: 200%;">
            ...
            <div class="card min-vh-100 cardBorder" style="width: 200%;">
                ...
                <div class="card-body mainDisplay">
                    ...
                    <div class="m-5">
                        <form class="fs-4" id="registrationForm" action="changePass.php" method="post">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Current
                                    Password</label>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">New
                                    Password</label>
                                <input type="password" name="newPass" class="fs-5 form-control" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Confirm
                                    Password</label>
                                <input type="password" name="conPass" class="fs-5 form-control" required>
                            </div>
