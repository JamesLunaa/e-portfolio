        ...
        <div class="card cardBorder d-flex flex-column flex-shrink-0"
            ...
            <div class="card-body border-end border-secondary">
                ...
                <ul class="fs-5 nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="addBook.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path
                                    d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                ...
                <div class="text-center">
                    ...
                    <div class="text-center mt-4 mx-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <form class="d-flex flex-fill gap-2" action="attendance.php" method="post">
                                <div class="input-group input-group-lg gap-3">
                                    <input name="info" type="text" class="form-control" aria-label="Sizing example input"
                                        aria-describedby="inputGroup-sizing-lg" placeholder="Search user I.D" required>
                                    <input name="year" type="text" class="form-control" aria-label="Sizing example input"
                                        aria-describedby="inputGroup-sizing-lg" placeholder="Year" required>
                                </div>
                            ...
                            <a href="attendance.php"><button type="submit"
                        ...
                        <div class="recHeight">
                            <table class="table table-dark">
                                ...
                                <tbody class="text-center">
                                    <?php
                                            include('../../model/admin/attendance.php');
                                            ?>
                                </tbody>
                            </table>
                        </div>
