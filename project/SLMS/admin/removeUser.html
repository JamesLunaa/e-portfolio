        ...
        <div class="d-flex min-vh-100" style="width: 200%;">
            ...
            <div class="card min-vh-100 cardBorder" style="width: 200%;">
                ...
                <div class="text-center mt-2 mx-4">
                        <form class="d-flex gap-2" action="removeUser.php" method="post">
                    ...
                    <div class="text-center">
                        <a href="addUser.php"><button type="submit" class="btn btn-danger btn-lg">Return</button></a>
                        <a href="removeUser.php"><button type="submit"
                        ...
                        <div class="vh-auto recHeight">
                            <table class="table table-dark">
                                ...
                                <tbody class="text-center">
                                    <?php
                                    include('../../model/admin/removeUser.php');
                                    ?>
                                </tbody>
                            </table>
                        </div>
