<?php
session_start();
include('../../control/admin/addUser.php');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="d-flex min-vh-100" style="width: 200%;">
            ...
            <div class="card min-vh-100 cardBorder" style="width: 200%;">
                ...
                <div class="card-body mainDisplay">
                    ...
                    <div class="m-5">
                        <form class="fs-4" id="registrationForm" action="addUser.php" method="post">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Name</label>
                                <input type="text" name="name" class="fs-5 form-control" placeholder="Enter Name Here"
                                    required>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Library
                                    I.D</label>
                                <input type="number" name="libId" class="fs-5 form-control" placeholder="Enter ID Here"
                                    required>
                            </div>
                        ...
                        <div>
                            <a href="removeUser.php"><button type="submit" class="btn btn-success mt-3">User
                                    List</button></a>
                        </div>
