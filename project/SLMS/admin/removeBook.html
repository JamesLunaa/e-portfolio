            ...
            <div class="card min-vh-100 cardBorder" style="width: 200%;">
                ...
                <div class="text-center">
                    ...
                    <div class="text-center mx-4">
                        <form class="d-flex gap-2" action="removeBook.php" method="post">
                    ...
                    <div class="text-center">
                        <a href="addBook.php"><button type="submit" class="btn btn-danger btn-lg">Return</button></a>
                        <a href="removeBook.php"><button type="submit"
                        ...
                        <div class="vh-auto recHeight">
                            <table class="table table-dark">
                                ...
                                <tbody class="text-center">
                                    <?php
                                    include('../../model/admin/removeBook.php');
                                    ?>
                                </tbody>
                            </table>
                        </div>
