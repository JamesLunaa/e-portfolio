<?php
session_start();
include('../../control/user/borrowBook.php');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="card cardBorder d-flex flex-column flex-shrink-0"
            ...
            <div class="card-header menuHead">
                <div class="fs-4 text-center mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="54" fill="currentColor"
                        class="bi bi-list-stars text-white" viewBox="0 0 16 16">
                        <path
                    ...
                    <strong class="text-white">STCTI Library MS</strong>
                </div>

            </div>
            <div class="card-body border-end border-secondary">

                <ul class="fs-5 nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <a href="searchBook.php" class="nav-link active" aria-current="page">
                    ...
                    <li>
                        <a href="requestStatus.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <li>
                        <a href="borrowedBook.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-list-stars" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                    d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5" />
                    ...
                    <li>
                        <a href="records.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <li>
                        <a href="suggFeed.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
            ...
            <div class="card-footer border-end border-secondary text-secondary text-center">
                @Capstone 2024
            </div>
        ...
        <div class="d-flex min-vh-100" style="width: 200%;">
            ...
            <div class="card min-vh-100 cardBorder" style="width: 200%;">
                <div class="card-header border-secondary">
                    <div class="dropdown d-flex justify-content-end">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                            ...
                            <strong class="fs-4"><?php echo htmlspecialchars($_SESSION['user']); ?></strong>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-white text-small shadow" aria-labelledby="dropdownUser1">
                            ...
                            <li><a class="dropdown-item" href="#" onclick="confirmLogout()">Sign out</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="card-body mainDisplay">
                    ...
                    <div class="m-5 recHeight">
                        <form class="row g-3 formBBookHeight text-dark fs-4" action="borrowBook.php" method="post">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="fs-4 form-control" id="inputTitle" name="title"
                                    value="<?php echo htmlspecialchars($_POST['title']); ?>" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="inputTitle" class="form-label">Author of the Book</label>
                                <input type="text" class="fs-4 form-control" id="inputAuthor"
                                    value="<?php echo htmlspecialchars($_POST['author']); ?>" readonly>
                            </div>
                            <div class="col-md-max">
                                <label for="exampleFormControlTextarea1" class="form-label">Synopsis</label>
                                <textarea class="form-control fs-4" id="exampleFormControlTextarea1" rows="3" readonly><?php
                                    echo htmlspecialchars($synopsis, ENT_QUOTES | ENT_HTML5);
                                ?></textarea>
                            </div>
                            <div>
                                <button type="submit" name="submit" class="mb-5 btn btn-success">Borrow</button>
                            </div>
                        </form>
                    </div>
