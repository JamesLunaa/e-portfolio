            ...
            <div class="card min-vh-100 cardBorder" style="width: 200%;">
                ...
                <div class="card-body mainDisplay">
                    ...
                    <div class="text-center mt-4 mx-4">
                        <form class="d-flex gap-2" action="approvedList.php" method="post">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="approvedList.php"><button type="submit"
                    ...
                    <section class="userList">
                        <div class="vh-auto">
                            <div class="text-center">
                                <a href="requestInbox.php"><button name="search"
                            ...
                            <table class="table table-dark">
                                ...
                                <tbody class="text-center">
                                    <?php
                                    include('../../model/admin/approvedList.php');
                                    ?>
                                </tbody>
                            </table>
                        </div>
